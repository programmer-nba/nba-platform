<template>
   <ion-page>
    ...
    <ion-content padding>
      <ion-col>
          <ion-item lines="none">
            <ion-label style="color: grey; font-size: 15px;"><p>ข้อมูลทั่วไป</p></ion-label>
          </ion-item>
          <ion-item :detail="false" >
            <ion-label><h3><strong>ชื่อ-นามสกุล :</strong></h3></ion-label>
            <p slot="end">{{ user?.name }}</p>
          </ion-item>
          <ion-item  :detail="false">
            <ion-label><h3><strong>เบอร์โทร :</strong></h3></ion-label>
            <p slot="end">{{ user?.tel }}</p>
          </ion-item>
          <ion-item :detail="false">
            <ion-label><h3><strong>ที่อยู่ :</strong></h3></ion-label>
              <p slot="end">{{ user?.address }}</p>
          </ion-item>
          <ion-item :detail="false">
            <ion-label><h3><strong>แขวง/ตำบล :</strong></h3></ion-label>
              <p slot="end">{{ user?.subdistrict }}</p>
          </ion-item>
          <ion-item :detail="false">
            <ion-label><h3><strong>เขตอำเภอ :</strong></h3></ion-label>
              <p slot="end">{{ user?.district }}</p>
          </ion-item>
          <ion-item :detail="false">
            <ion-label><h3><strong>จังหวัด :</strong></h3></ion-label>
              <p slot="end">{{ user?.province }}</p>
          </ion-item>
          <ion-item :detail="false">
            <ion-label><h3><strong>รหัสไปรษณีย์ :</strong></h3></ion-label>
              <p slot="end">{{ user?.postcode }}</p>
          </ion-item>

          <!-- IDEN  -->
          <ion-item lines="none">
            <ion-label style="color: grey; font-size: 15px;"><p>ข้อมูลบัตรประชาชน</p></ion-label>
          </ion-item>
          <ion-item :detail="false" >
            <ion-label><h3><strong>สถานะ :</strong></h3></ion-label>
            ...
            <ion-button  elevation="0" class="btn-primary" v-if="!user?.iden.status && user?.iden.remark === '-'">ยืนยันตอนนี้</ion-button>
          </ion-item>
          <ion-item  :detail="false">
            <ion-label><h3><strong>หมายเลขบัตร :</strong></h3></ion-label>
            <p slot="end">{{ user?.iden.number }}</p>
          </ion-item>
          <ion-item :detail="false">
            <ion-label><h3><strong>รูปที่แนบ :</strong></h3></ion-label>
              <ion-button id="open-custom-dialog" class="btn-img"><ion-icon style="margin-right: 10px;" :icon="image"></ion-icon>ดูรูปภาพ</ion-button>
          ...
          <ion-item :detail="false">
            <ion-label><h3><strong>*หมายเหตุ :</strong></h3></ion-label>
        ...
        <!-- BANK -->
          <ion-item lines="none">
            <ion-label style="color: grey; font-size: 15px;"><p>ข้อมูลบบัญชีธนาคาร</p></ion-label>
          </ion-item>
          <ion-item :detail="false" >
            <ion-label><h3><strong>สถานะ :</strong></h3></ion-label>
            <ion-chip v-if="user?.iden.status" color="success">ยืนยันแล้ว</ion-chip>
          ...
          <ion-item :detail="false">
            <ion-label><h3><strong>รูปที่แนบ :</strong></h3></ion-label>
              <ion-button id="open-bank-dialog" class="btn-img"><ion-icon style="margin-right: 10px;" :icon="image"></ion-icon>ดูรูปภาพ</ion-button>
